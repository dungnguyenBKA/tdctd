...
struct ErrorMessage errors[100] = {
  ...
  {ERR_INVALIDDOUBLE, "Invalid double."},
  {ERR_UNDECLARED_NUMBER_CONSTANT, "Undeclared number constant."},
  {ERR_ASSIGNMENT_INCONSISTENCY, "Assignment inconsistency."},
{ERR_ASSIGN_LEFT_LESS, "ERR ASSIGN_LEFT_LESS."},
{ERR_ASSIGN_LEFT_MORE, "ERR ASSIGN_LEFT_MORE."}
};
